...
In this tutorial we will use SQLite which is a quick and easy alternative to implement.
SQLite must be installed and enabled on your system.

For Apache on Ubuntu 20.04 :

```bash
sudo apt install sqlite3 libsqlite3-dev php-sqlite3
...
### Enable Database and Faker services in your app

Open **src/App.php** application file.
...
Create **src/Providers/DatabaseServiceProvider.php** the database service provider file.
